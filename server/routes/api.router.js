...
perenualRouter.get('/details/:details', rejectUnauthenticated, (req, res) => {
...
perenualRouter.get('/careDetails/:careDetails', rejectUnauthenticated, (req, res) => {
...
perenualRouter.get('/search/:search', rejectUnauthenticated, (req, res) => {
